package org.ohmyopensource.ohmyuniversity.canteen.security;
 ...
 *
 * This filter trusts the gateway completely — it does NOT validate any JWT.
 * This is correct because the chat service sits behind the gateway and is never
